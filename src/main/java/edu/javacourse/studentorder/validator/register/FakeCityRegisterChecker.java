...
public class FakeCityRegisterChecker implements CityRegisterChecker {
    ...
    private final static String GOOD_1 = "1000";
    private final static String GOOD_2 = "2000";
    private final static String BAD_1 = "1001";
    private final static String BAD_2 = "2001";
